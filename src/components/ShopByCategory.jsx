...
const categories = [
  { label: 'Tops', image: assets.p_img3, value: 'Tops' },
  { label: 'Jeans', image: assets.p_img4, value: 'Jeans' },
  { label: 'Shirts', image: assets.p_img39, value: 'Shirts' },
  { label: 'Dresses', image: assets.p_img5, value: 'Dresses' },
  { label: 'Shorts', image: assets.p_img8, value: 'Shorts' },
  ...
  { label: 'Trackpants', image: assets.p_img16, value: 'Trackpants' },
];
