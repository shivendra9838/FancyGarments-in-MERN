    ...
    <div className="bg-gray-50">
      ...
      <section className="max-w-4xl mx-auto px-4 mb-12">
        ...
        <div className="flex justify-center mt-4">
          <button
            onClick={() => handleAgentClick({ name: 'Ishaan', avatar: ishaan, status: 'Available now', online: true })}
          ...
          >
            <span className="text-xl">💬</span> Live Chat with Ishaan
          </button>
        </div>
      </section>
